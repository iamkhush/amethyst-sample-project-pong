...
core::timing::Time, ecs::Entity, ui::TtfFormat, ui::UiTransform, ui::Anchor, ui::UiText, ui::LineMode};
...
fn load_sprite_sheet(world: &mut World) -> Handle<SpriteSheet> {
    ...
    loader.load("texture/pong_spritesheet.ron",SpriteSheetFormat(texture_handle), (), &sprite_sheet_store)
}
